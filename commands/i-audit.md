...
- **Suggested command**: Which command to use (e.g., `/i-normalize`, `/i-optimize`, `/i-harden`)
...
- "Use `/i-normalize` to align components with design system (addresses 23 theming issues)"
- "Use `/i-optimize` to improve performance (addresses 12 performance issues)"
- "Use `/i-harden` to improve i18n and text handling (addresses 8 edge cases)"
