...
### Current Focus Areas (with overlap issues)

| Area | Current Owner | Overlap Problem |
|------|---------------|-----------------|
| Shipping / Consignment | Sjoerd, Fatjon | Unclear boundary between shipment and consignment |
| Visibility / Tracking | Sjoerd | Overlaps with exception handling in Shipping |
| Freight Settlement / Rates | Bram | Needs carrier data from multiple teams |
| Carrier Portal | Nick? | Everyone needs carrier integrations |
...
| **Wouter** | Vision-focused | Data engineering, Operations, Supply chain | Strategic, cross-functional, analytics | New initiatives, cross-team alignment |
